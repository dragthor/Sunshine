 ...
 */
public class WeatherDataParserTests extends AndroidTestCase {
    ...
    public void testAble_to_get_max_temperature_for_first_day()  {
        double actual = 0;
    ...
    public void testAble_to_get_max_temperature_for_last_day()  {
        double actual = 0;
